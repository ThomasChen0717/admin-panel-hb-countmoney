    ...
    <div class="container">
      <div class="content">
        ...
        <label style="font-weight: normal;"> 日期:
            <el-date-picker v-model="selectedDay" type="date" @change="updateChart"></el-date-picker>
        </label>
      ...
      <div class="chart-container">
        <chart height="100%" width="100%" :chartData="chartData" :hour = "selectedHour"/>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    data() {
        return{
            ...
            selectedDay: new Date(Date.UTC(2023, 5, 19)  - 8 * 60 * 60 * 1000),
            hours: [
